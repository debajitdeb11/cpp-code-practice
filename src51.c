// Example GeeksforGeeks Problem on LinkList
...
You should not read any input from stdin/console. The struct Node has a data part which 
...
Explanation:
Testcase 1: Here the first line denotes an integer 'T' the no of test cases and the next line 
denotes 'N' the no of nodes of linked list. 
